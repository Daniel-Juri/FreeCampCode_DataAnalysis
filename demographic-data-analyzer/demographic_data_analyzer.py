...
def calculate_demographic_data(print_data=True):
    ...
    men = df.loc[df['sex'] == 'Male', 'age'].mean()
    ...
    high_salary_count_per_country = df[df['salary'] == ">50K"]['native-country'].value_counts()
    num_country = df['native-country'].value_counts()
    percentage = high_salary_count_per_country/num_country * 100
